...
export default {
    ...
    mounted(){
      this.$axios.get("http://localhost:8080/myoneday/main").then(({data}) => {
        let recentClassInfoList = data.recentClassInfoList;

        this.cardsList1 = recentClassInfoList.slice(0,4);
        this.cardsList2 = recentClassInfoList.slice(4,8);
        this.cardsList3 = recentClassInfoList.slice(8,12);                  
